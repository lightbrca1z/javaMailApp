        ...
        <div class="history-container">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="${pageContext.request.contextPath}/deleteSingleHistory" method="post" style="display:inline;">
            ...
            <div style="margin-top: 15px;">
                ...
                <button type="button" class="btn btn-danger" 
                        onclick="if(confirm('本当にすべての履歴（<%= messageCount %>件）を削除しますか？\n\nこの操作は取り消せません。')) { window.location.href='${pageContext.request.contextPath}/deleteHistory'; }"
                        title="すべての履歴を削除">
                    🗑️ すべての履歴を削除
                </button>
